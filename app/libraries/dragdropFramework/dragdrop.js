(function($) {
    var defaultOptions = {
        ...
        parentContainer: null, //if set the element is created in this context 
        ...
        onStart: function(event) {
            ...
            if ($element) {
                ...
                if (options.makeClone) {
                    ...
                    if(options.parentContainer){parentElement = options.parentContainer;}
                    $activeElement.appendTo(parentElement);
